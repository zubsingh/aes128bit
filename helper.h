...
// substitution box
  static unsigned char aes_s_box[256] = {
  ...
  static unsigned char aes_inv_s_box[256] = {
  ...
  static unsigned char aes_inv_mixColMat[AES_BLOCK_SIDE][AES_BLOCK_SIDE] = {
    {0x0E, 0x0B, 0x0D, 0x09},
    {0x09, 0x0E, 0x0B, 0x0D},
    {0x0D, 0x09, 0x0E, 0x0B},
    {0x0B, 0x0D, 0x09, 0x0E} };
...
static unsigned char Rcon[10][10] = {
    {0x01,0x00,0x00,0x00},
    {0x02,0x00,0x00,0x00},
    {0x04,0x00,0x00,0x00},
    {0x08,0x00,0x00,0x00},
...
static unsigned char aes_mixColMat[AES_BLOCK_SIDE][AES_BLOCK_SIDE] = {
    {0x02, 0x03, 0x01, 0x01},
    {0x01, 0x02, 0x03, 0x01},
    {0x01, 0x01, 0x02, 0x03},
    {0x03, 0x01, 0x01, 0x02} };
